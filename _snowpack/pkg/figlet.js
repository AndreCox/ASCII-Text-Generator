...
var figlet = figlet || (function() {
    ...
    */
    ...
    function generateFigTextLines(txt, figChars, opts) {
        var charIndex, figChar, overlap = 0, row, outputFigText, len, height=opts.height, outputFigLines = [], maxWidth, nextFigChars, figWords = [], char, isSpace, textFigWord, textFigLine, tmpBreak;
